...
- An easy way to create a bunch of custom tools for an Model Context Protocol (MCP) server - see Anthropic [MCP specs](https://modelcontextprotocol.io/specification/2025-06-18/basic) for more info.
